...
| `GROQ_MODELS` | No | built-in list | Comma-separated Groq model fallback chain (best first), e.g. `openai/gpt-oss-120b,openai/gpt-oss-20b` — override when the built-in list ages |
